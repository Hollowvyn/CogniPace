...
} from "@features/overlay-session/ui/screens/controller/draftFields";
import {
  buildDueTone,
  buildHeaderStatus,
  formatSubmissionDateLabel,
} from "@features/overlay-session/ui/screens/controller/headerStatus";
import { StudyState } from "@features/study";
import { describe, expect, it } from "vitest";

import { makeScheduledState } from "../../support/fixtures";

describe("overlay-session contracts", () => {
  it.each([
  ...
  it.each([
    { state: makeScheduledState("2026-03-30T00:00:00.000Z"), expected: "RECALL" },
